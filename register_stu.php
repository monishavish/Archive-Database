...
<body>
	...
	<b><br><h2>Register-Student.</h2></b><br>
	<hr style="height:1px;border:none;color:#333;background-color:#333;" width="60%">
	<form method="post" action="register-stu1.php">
		<div class="container">
			<input type="text" class="form-control" name="name" placeholder="Enter name" size="40"/><br>
			<input type="text" class="form-control" name="id" placeholder="Enter USN" size="40"/><br>
			<input type="email" class="form-control" name="email" placeholder="Enter E-mail" size="40"/><br>
			<input type="text" class="form-control" name="deptid" placeholder="Enter department id" size="40"/><br>
			<a class="idd" href="deptno.php"><button type="button" class="buttonn">( Know Your Department ID. )</button></a>
			<br><br>
			<input type="text" class="form-control" name="contact" placeholder="Enter contact" size="40"/><br>
